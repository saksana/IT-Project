                        ...
                        <div class="card-body p-2">
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-6 col-lg-6 d-flex flex-column align-items-center justify-content-center text-white py-2" style="background-color:#ff9900">
                                    <img src="img/man.png" class="" style="width:100px;height:100px">
                                    <h5 class="text-dark">ຜູ້ໃຊ້ງານລະບົບ</h5>
                                </div>

                                <div class="col-12 col-sm-12 col-md-6 col-lg-6 bg-white py-4">
                                    <div class="text-end">
                                        <a class="btn btn-sm btn-dark" href="admin/adminlogin.php">Admin</a>
                                    </div>

                                    <div class="text-center mt-1">
                                        <h4 class="">ເຂົ້າສູ່ລະບົບ</h4>
                                    </div>
                                    <form name="loginForm" action="user/userchecklogin.php" method="POST" onsubmit="return validateForm()">
