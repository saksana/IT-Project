                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="">
                        <div class="card-body p-2">
                            <div class="row">
                                <div class="col-1 col-sm-1 col-md-6 col-lg-6 d-flex flex-column align-items-center justify-content-center text-white py-5" style="background-color:#000099">
                                    <div class="justify-content-center fs-3" class=""><span class="d-none d-sm-none d-md-inline d-lg-inline">IT</span> <span class="d-none d-sm-none d-md-inline d-lg-inline">DEPARTMENT</span></div>
                                    <div class="justify-content-center fs-6 d-none d-sm-none d-md-inline d-lg-inline">SYSTEM & SUPPORT</div>
                                </div>

                                <div class="col-11 col-sm-11 col-md-6 col-lg-6 bg-white py-4">
                                    <div class="text-end">
                                        <a class="btn btn-sm btn-primary" href="../index.php">ກັບຄືນ</a>
                                    </div>

                                    <div class="text-center mt-1">
                                        <h4 class="">Admin</h4>
                                    </div>
                                    <form name="loginForm" action="adminchecklogin.php" method="POST" onsubmit="return validateForm()">
